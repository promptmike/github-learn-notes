...
- **Settings Sync** to synchronise VS Code settings between desktop and web client
- **Dotfiles** to specify scripts, shell preferences and other configurations
- **Rename** to change the display name
- **Change your shell** in a new terminal or by configuring the dotfiles
- **Change the machine type** to change the type of VM
- **Set the default editor** to VS Code (desktop or web client), JetBrains Gateway or JupyterLab
- **Set the default region** to decide where your data is held
