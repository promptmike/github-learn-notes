...
- Plan and track work in table or board view
- Rank, sort and group within table by custom field
- Draft issues with descriptions and metadata
- Tokenised filtering and saved views
